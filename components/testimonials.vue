<template>
  <v-row justify="center" align="center" class="ma-0">
    <v-col class="testimonials" :class="$vuetify.breakpoint.lgAndUp ? 'py-16' : ''" justify="center" align="center" cols="12">
      ...
      <p class="testimonials-subinfo">
        Need even more convincing? <br> Here is what our customers say about us
      </p>
    </v-col>
    ...
    <v-col class="testimonials brands" :class="$vuetify.breakpoint.lgAndUp ? 'py-16' : ''" justify="center" align="center" cols="12">
      <v-img v-for="img of brandImgs" class="img" :width="$vuetify.breakpoint.lgAndUp ? '90' : '120'" :height="$vuetify.breakpoint.lgAndUp ? '90' : '60'" :src="require(`~/static/images/${img.img}`)" />
    </v-col>
  </v-row>
</template>
